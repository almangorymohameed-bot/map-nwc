  ...
  const handleInstallClick = async () => {
    if (deferredPrompt) {
      ...
      alert(
        ...
        '1. انقر على زر المشاركة (Share) في متصفحك\n' +
        ...
        <div className="flex items-start gap-3.5 relative z-10">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-300 mt-1 leading-relaxed">
              يمكنكم الآن تثبيت التطبيق مباشرة على جهازكم للوصول السريع والعمل بسلاسة بدون انقطاع.
            </p>
...
export const PWAInstallHeaderButton: React.FC = () => {
  ...
  const handleInstallClick = async () => {
    if (deferredPrompt) {
      ...
      alert(
        'لتثبيت التطبيق على جهازك:\n\n' +
        '1. انقر على قائمة خيارات المتصفح (⋮ أو زر المشاركة)\n' +
        '2. اختر "التثبيت كـ تطبيق" أو "إضافة إلى الشاشة الرئيسية"'
      );
    }
  };
